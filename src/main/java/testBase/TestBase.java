...
public class TestBase {
	...
	public static void Initialize() throws IOException {
		...
		f = new File(System.getProperty("user.dir")+"/src/test/java/propertiesFiles/NYL_Carrier.properties");
		FI = new FileInputStream(f);
		Repository.load(FI);
		
		f = new File(System.getProperty("user.dir")+"/src/test/java/propertiesFiles/NYL_Carrier_Joint.properties");
		FI = new FileInputStream(f);
		Repository.load(FI);
		
		f = new File(System.getProperty("user.dir")+"/src/test/java/propertiesFiles/NYL_Carrier_Custodial.properties");
		FI = new FileInputStream(f);
		Repository.load(FI);
		
		f = new File(System.getProperty("user.dir")+"/src/test/java/propertiesFiles/CAN.Properties");
		FI = new FileInputStream(f);
		Repository.load(FI);
